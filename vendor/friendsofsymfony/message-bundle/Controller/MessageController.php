...
class MessageController extends AbstractController
{
    ...
    /**
     * Displays the authenticated participant binbox.
     *
     * @return Response
     */
    public function binboxAction()
    {
   
        return $this->container->get('templating')->renderResponse('FOSMessageBundle:Message:binbox.html.twig');
    }
