...
$catalogue = new MessageCatalogue('eu_1', array (
  'FOSUserBundle' => 
  array (
...
$catalogueEu = new MessageCatalogue('eu', array (
  'validators' => 
  array (
...
$catalogue->addFallbackCatalogue($catalogueEu);
...
$catalogueEu->addFallbackCatalogue($catalogueFr);
