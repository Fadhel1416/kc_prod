...
$catalogue = new MessageCatalogue('el_1', array (
  'FOSUserBundle' => 
  array (
...
$catalogueEl = new MessageCatalogue('el', array (
  'validators' => 
  array (
...
$catalogue->addFallbackCatalogue($catalogueEl);
...
$catalogueEl->addFallbackCatalogue($catalogueFr);
