...
$catalogue = new MessageCatalogue('eo_1', array (
  'FOSUserBundle' => 
  array (
...
$catalogueEo = new MessageCatalogue('eo', array (
  'FOSUserBundle' => 
  array (
    'group.edit.submit' => 'Aktualigi',
    'group.show.name' => 'Grupnomo',
...
$catalogue->addFallbackCatalogue($catalogueEo);
...
$catalogueEo->addFallbackCatalogue($catalogueFr);
