...
$catalogue = new MessageCatalogue('lb_1', array (
  'FOSUserBundle' => 
  array (
...
$catalogueLb = new MessageCatalogue('lb', array (
  'validators' => 
  array (
...
$catalogue->addFallbackCatalogue($catalogueLb);
...
$catalogueLb->addFallbackCatalogue($catalogueFr);
