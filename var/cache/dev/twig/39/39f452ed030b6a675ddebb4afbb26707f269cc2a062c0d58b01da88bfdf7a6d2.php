...
class __TwigTemplate_2cf8ced17060f7148a7df3deb12d406ae3216a432222fdf67b96ac7e7be39980 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
            ...
            <a class=\"page-link\" rel=\"prev\" href=\"";
                ...
                echo "\">&laquo;&nbsp;";
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("precedent", [], "KnpPaginatorBundle"), "html", null, true);
                echo "</a>
        </li>
    ";
            } else {
...
{% if pageCount > 1 %}
    ...
    {% if previous is defined %}
        <li class=\"page-item\">
            <a class=\"page-link\" rel=\"prev\" href=\"{{ path(route, query|merge({(pageParameterName): previous})) }}\">&laquo;&nbsp;{{ 'precedent'|trans([], 'KnpPaginatorBundle') }}</a>
        </li>
    {% else %}
        <li class=\"disabled page-item\">
            <a class=\"page-link\">&laquo;&nbsp;{{ 'precedent'|trans([], 'KnpPaginatorBundle') }}</a>
        </li>
    {% endif %}
...
{% endif %}
", "KnpPaginatorBundle:Pagination:twitter_bootstrap_v3_pagination.html.twig", "C:\\wamp64\\www\\kc_prod\\vendor\\knplabs\\knp-paginator-bundle/Resources/views/Pagination/twitter_bootstrap_v3_pagination.html.twig");
    }
}
