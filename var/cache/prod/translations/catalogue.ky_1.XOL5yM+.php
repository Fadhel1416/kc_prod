...
$catalogue = new MessageCatalogue('ky_1', array (
  'FOSUserBundle' => 
  array (
...
$catalogueKy = new MessageCatalogue('ky', array (
  'FOSUserBundle' => 
  array (
    'group.edit.submit' => 'Группаны жаңылоо',
    'group.show.name' => 'Группанын аталышы',
...
$catalogue->addFallbackCatalogue($catalogueKy);
...
$catalogueKy->addFallbackCatalogue($catalogueFr);
