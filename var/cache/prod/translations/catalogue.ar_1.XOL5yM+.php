...
$catalogue = new MessageCatalogue('ar_1', array (
  'FOSUserBundle' => 
  array (
...
$catalogueAr = new MessageCatalogue('ar', array (
  ...
  array (
    ...
    'fos_user.group.long' => ' إسم المجموعة طويل جدا',
    'fos_group.name.already_used' => 'هذا الإسم غير متاح.',
    'fos_message.recipient.blank' => 'لم يتم تحديد إي مستقبل',
    'fos_message.recipients.blank' => 'لم يتم تحديد المستقبلين',
    'fos_message.subject.blank' => 'رجاء ادخل العنوان',
    'fos_message.subject.short' => 'العنوان قصير جدا|العنوان قصير جدا',
    'fos_message.subject.long' => 'العنوان طويل جدا|العنوان طويل جدا',
    'fos_message.body.blank' => 'رجاء ادخل محتوى الرساله',
    'fos_message.body.short' => 'المحتوى قصير جدا',
    'fos_message.body.spam' => 'عذرا , لكن رسلاتك تبدو كرسالة مزعجة',
    'fos_message.not_authorized' => 'إنك لا تملك التصريح اللازم لإرسال هذه الرساله',
    'fos_message.reply_not_authorized' => 'إنك لا تملك التصريح اللازم لرد على هذه الرساله',
    'fos_message.self_recipient' => 'لا يمكنك إرسال رساله لنفسك',
  ),
  'security' => 
  array (
...
$catalogueAr->addFallbackCatalogue($catalogueFr);
