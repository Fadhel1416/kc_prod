...
$catalogue = new MessageCatalogue('lv_1', array (
  'FOSUserBundle' => 
  array (
...
$catalogueLv = new MessageCatalogue('lv', array (
  'validators' => 
  array (
...
$catalogue->addFallbackCatalogue($catalogueLv);
...
$catalogueLv->addFallbackCatalogue($catalogueFr);
