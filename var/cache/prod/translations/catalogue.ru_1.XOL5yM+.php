...
$catalogue = new MessageCatalogue('ru_1', array (
  'FOSUserBundle' => 
  array (
...
$catalogueRu = new MessageCatalogue('ru', array (
  ...
  array (
    ...
    'fos_user.group.long' => 'Название группы слишком длинное.',
    'fos_group.name.already_used' => 'Имя уже используется.',
    'fos_message.recipient.blank' => 'Не указан адресат',
    'fos_message.recipients.blank' => 'Не указаны адресаты',
    'fos_message.subject.blank' => 'Укажите тему',
    'fos_message.subject.too_short' => 'Название темы слишком короткое|Название темы слишком короткое',
    'fos_message.subject.too_long' => 'Название темы слишком длинное|Название темы слишком длинное',
    'fos_message.body.blank' => 'Введите текст сообщения',
    'fos_message.body.too_short' => 'Текст сообщения слишком короткий',
    'fos_message.body.spam' => 'Сожалеем, но ваше сообщение похоже на спам',
    'fos_message.not_authorized' => 'Вы не можете отправить это сообщение',
    'fos_message.self_recipient' => 'Вы не можете отправить сообщение самому себе',
  ),
  'security' => 
  array (
...
',
  ...
  array (
    ...
    'actions' => 'Действия',
    'new' => 'Новое',
    'goto_last' => 'К последнему сообщению',
    'on' => 'Дата %date%',
    'by' => 'От %sender%',
    'no_thread' => 'Нет цепочек для отображения',
    'delete' => 'Удалить',
...
$catalogueRu->addFallbackCatalogue($catalogueFr);
