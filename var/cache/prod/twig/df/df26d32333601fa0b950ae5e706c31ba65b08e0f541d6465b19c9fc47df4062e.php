...
class __TwigTemplate_96a0bd4ad083b2670c6c61b2e099dc04b2be9c21605d4be38417e9bef035767d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t
    ...
    ";
     ...
     <div class=\"col-sm-10\">
         ";
        // line 255
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "Num_facture", [], "any", false, false, false, 255), 'errors');
        echo "
        ";
        // line 256
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "Num_facture", [], "any", false, false, false, 256), 'widget', ["attr" => ["class" => "form-control inp  placeholder-no-fix", "placeholder" => "Numero Facture"]]);
        echo "
        </div>
       </div>
       <br>
