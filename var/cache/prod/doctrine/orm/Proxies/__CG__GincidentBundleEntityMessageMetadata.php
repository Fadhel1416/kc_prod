 ...
 */
class MessageMetadata extends \GincidentBundle\Entity\MessageMetadata implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'message', 'participant', 'isRead'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MessageMetadata $proxy) {
