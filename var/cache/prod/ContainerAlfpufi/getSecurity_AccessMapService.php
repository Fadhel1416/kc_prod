...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/intervenant'), [0 => 'ROLE_INTERVENANT'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/AGENT'), [0 => 'ROLE_AGENT'], NULL);
